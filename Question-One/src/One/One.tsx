...
export const One = ({ className, ...props }: IOneProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-row gap-3 items-center justify-center self-stretch flex-1 relative">
          <div 
            ...
            <div
              className="text-[#ffffff] text-center font-['Inter-SemiBold',_sans-serif] text-xl leading-7 font-semibold relative self-stretch flex items-center justify-center"
              style={{ 
                letterSpacing: "-0.025em",
          ...
          >
            <div
              ...
              className="text-[#eaeaea] text-center font-['Inter-SemiBold',_sans-serif] text-xl leading-7 font-semibold relative self-stretch flex items-center justify-center"
              style={{ 
                letterSpacing: "-0.025em",
      ...
      <div
        className="text-[#b0b0b0] text-center font-['Inter-SemiBold',_sans-serif] text-xl leading-7 font-semibold absolute left-[50%] top-[356px] flex items-end justify-center"
